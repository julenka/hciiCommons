...
void testApp::setup()
{
	...
	//Loading images of IDEO letters
	i_ltr.loadImage("H.jpg");
	d_ltr.loadImage("C.jpg");
	e_ltr.loadImage("I.jpg");
	o_ltr.loadImage("I.jpg");
...
void testApp::drawLetters(){
	...
	for(int i=0;i<nbRects;i++){
		...
		switch (use) {
			case 1:
				i_ltr.draw(-rects[i].getWidth(),-rects[i].getHeight(), rects[i].getWidth()*2, rects[i].getHeight()*2);
				break;
			case 2:
				d_ltr.draw(-rects[i].getWidth(),-rects[i].getHeight(), rects[i].getWidth()*2, rects[i].getHeight()*2);
				break;
			case 3:
				e_ltr.draw(-rects[i].getWidth(),-rects[i].getHeight(), rects[i].getWidth()*2, rects[i].getHeight()*2);
				break;
			case 4:
				o_ltr.draw(-rects[i].getWidth(),-rects[i].getHeight(), rects[i].getWidth()*2, rects[i].getHeight()*2);
				break;
		}
		...
		for(int j=0;j<1;j++){
			...
			float pctW = 0.05;
			float tL = ofRandom(-rects[i].getWidth()*pctW, rects[i].getWidth()*pctW);
			float tR = ofRandom(-rects[i].getWidth()*pctW, rects[i].getWidth()*pctW);
			float bL = ofRandom(-rects[i].getWidth()*pctW, rects[i].getWidth()*pctW);
			float bR = ofRandom(-rects[i].getWidth()*pctW, rects[i].getWidth()*pctW);
			ofBeginShape();
			ofVertex(-rects[i].getWidth()+tL, -rects[i].getHeight()+tR);
			ofVertex(rects[i].getWidth()+bL, -rects[i].getHeight()+tR);
			ofVertex(rects[i].getWidth()+tL, rects[i].getHeight()+bR);
			ofVertex(-rects[i].getWidth()+bL, rects[i].getHeight()+tL);
			ofEndShape(true);
		}
